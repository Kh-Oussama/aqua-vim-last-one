...
const SearchProductItem = ({ description, type, mark, linkUrl, func}) => {

    return (
        <div className="event_card  s-product-card">
            <div className="image-data">
                <div className="event_date s-event-data">
            ...
            <div className="post-data post-data-p">
                <h1 className="title"><i className="fas fa-tools"/> {type} </h1>
                <h2 className="subtitle s-subtitle"><i className="far fa-clock"/> {mark}</h2>
                ...
                <div className="cta">
                    <Link to={`/categories/sous_Categories/products/view_product/${linkUrl}`} onClick={func}>
                        Consulter &rarr;
                    </Link>
                </div>
            </div>
